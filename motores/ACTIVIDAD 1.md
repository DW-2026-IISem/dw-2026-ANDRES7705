## actividad instalacion motores desarollo web
...
```
<p align="center">
  <img src="capturas/carpeta compartida.PNG">
</p>
...
``` bash
TZ=America/Bogota
MYSQL_ROOT_PASSWORD=andres123453
MYSQL_DATABASE=moscote
...
TZ=America/Bogota
POSTGRES_DB=andresmoscote02
POSTGRES_USER=moscote
POSTGRES_PASSWORD=andresmosco123
...
```bash
docker exec -it postgres-server psql -U moscote -d andresmoscote02
# Password: andresmosco123
```
...
TZ=America/Bogota
ACCEPT_EULA=Y
MSSQL_SA_PASSWORD=Amoscote3456$
MSSQL_PID=Developer
EOF
```
<p align="center">
...
```bash
docker exec -it mssql-server /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P 'Amoscote3456$' -C
```
...
TZ=America/Bogota
ORACLE_PASSWORD=Oracleandres45
ORACLE_DATABASE=XE
EOF
```
<p align="center">
